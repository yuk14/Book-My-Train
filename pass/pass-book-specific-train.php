<?php
    ...
    if(isset($_POST['Book_Train']))
    {
            ...
            */
            ...
            $pass_train_class = $_POST['pass_train_class'];
                ...
                <div class="card-body">
                  <form method ="POST">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" readonly name="pass_dep_station" value="<?php echo $row->source;?>" id="inputText3" type="text">
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3"> Class</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" readonly name="pass_train_class" value="<?php echo $row->Class;?>" id="inputText3" type="text">
                      </div>
                    </div>
                    <div class="form-group row">
