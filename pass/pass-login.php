...
<?php
    ...
    if(isset($_POST['pass_login']))
    {
      ...
      $pass_pwd=sha1($_POST['pass_pwd']);//double encrypt to increase security
...
<head>
  ...
  <body class="be-splash-screen" style="background-image: url('bg.jpeg'); 
        ...
        <div class="main-content container-fluid">
          <div class="splash-container">
            <div class="card card-border-color card-border-color-success">
              <div class="card-header"><img class="logo-img" src="logo.png" alt="logo" width="140" height="100"><span class="splash-description">Please enter your user information.</span></div>
              <div class="card-body">
            ...
            <div class="splash-footer"><!--&copy; 2019 - <?php echo date ('Y');?> Book My Train | Developed By Martin Mbithi Nzilani--></div>
          </div>
        </div>
      </div>
    </div>
