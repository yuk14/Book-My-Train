...
<head>
  ...
  <body class="be-splash-screen" style="background-image: url('back.jpg'); 
        ...
        <div class="main-content container-fluid">
          <div class="splash-container">
            <div class="card card-border-color card-border-color-success">
              <div class="card-header"><img class="logo-img" src="logo.png" alt="logo" width="100" height="80"><span class="splash-description">Passenger Registration Form</span></div>
              <div class="card-body">
